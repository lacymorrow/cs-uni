...
public class Loan
{
    ...
    public void displayLoan(){
        System.out.println("Initial Principle: "+getInitialPrinciple());
        System.out.println("Current Balance: "+getCurrentBalance());
        System.out.println("Monthly Payment: "+monthlyPayment);
        System.out.println("Payments Remaining: "+(term-paymentsMade));
    }
    ...
    {
        return roundToCents(initialPrinciple);
    }
    /**
     * getCurrentBalance
     * 
    ...
    {
        return roundToCents(currentBalance);
    }
    /**
    ...
    {
        return roundToCents(monthlyInterestRate);
    }
    /**
     * getTerm
     * 
