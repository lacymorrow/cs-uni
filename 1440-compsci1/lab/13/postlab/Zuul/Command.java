...
public class Command
{
    ...
    public boolean perform(Player player, Castle castle) 
    {
        ...
        else if (commandWord.equals("quaff"))
            quaffBeverage(player, castle);
    ...
    private void quaffBeverage(Player player, Castle castle){
        if(! this.hasSecondWord()) {
            // if there is no second word, we don't know where to go...
            System.out.println("Quaff what?");
            return;
        }
        String direction = secondWord;

        // current room.
        Room room = castle.getCurrentRoom();
        if (room instanceof FurnishedRoom){
            FurnishedRoom fRoom = (FurnishedRoom) room;
            RoomItem drink = fRoom.removeItem(this.secondWord);
            if(drink == null){
                System.out.println("That item is not in this room.");
            } else {
                if (drink instanceof LifePotion){
                    player.addLife(player.maxLives);
                    System.out.println("Mmmm, that was tasty and you feel much better.");
                } else if (drink instanceof LifePotion){
                    player.loseLife();
                    System.out.println("As soon as you swallow you begin to feel ill.");
                }
            }
        } else {
